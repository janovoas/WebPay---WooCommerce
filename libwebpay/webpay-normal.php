...
class WebPayNormal
{
    ...
    function __construct($config)
    {
		...
		$this->soapClient = new WSSecuritySoapClient($url, $privateKey, $publicCert, $params);
    }
	...
	public function initTransaction($amount, $sessionId="", $ordenCompra="0", $urlFinal){
        ...
        $this->logger->writeLog('initTransaction',$wsTransactionDetail->buyOrder ,$wsTransactionDetail, $wsInitTransactionOutput, true);
				...
				$certificateTransbank = isset($_COOKIE["certificateTransbank"]) ? $_COOKIE["certificateTransbank"] : 'No set.';
				$error["detail"] = "No se puede validar la respuesta usando certificado " . $certificateTransbank;
		    }
